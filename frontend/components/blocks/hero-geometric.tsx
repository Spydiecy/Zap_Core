...
function HeroGeometric({
    badge = "AI Blockchain Assistant",
    title1 = "Transform Your Blockchain",
    title2 = "Experience with ZAP",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
}) {
    const fadeUpVariants1 = {
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <motion.a
                            href="/ai-chat"
                            className="bg-white text-black px-8 py-4 rounded-full font-semibold text-lg hover:bg-white/90 transition-all duration-300 shadow-lg hover:shadow-xl"
